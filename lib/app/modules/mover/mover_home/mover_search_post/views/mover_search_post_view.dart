      ...
      body: AppBackground(
        child: Column(
          ...
          children: [
            ...
            Text(
              "Search Posted Move By Location ",
              style: textStyele.titleLarge,
            ),
            SizedBox(height: 4.h),
            Text(
              "Enter the locations to see the job posts.",
                ...
                children: [
                  SizedBox(
                    ...
                    child: TextFormField(
                      onTap: () {
                        Get.toNamed(
                          Routes.MOVER_LOCATION_CITY,
                          arguments: {AppArgumentString.ispicup: true},
                        );
                      },
                      cursorHeight: 20.h,
                      readOnly: true,
                  ...
                  SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Image.asset(Assets.iconsFrom),
                        isDense: true,
                  ...
                  AppButton(
                    titel: "Search Moves",
                    onPress: () {
                      if (controller.pickupController.text != null &&
                          controller.dropoffController != null) {
