      ...
      body:AppBackground(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Log in to your Moveforce account to continue",style: textStyle.headlineLarge,),
            SizedBox(height: 08.h,),
            Text("Provide information to log in.",style: textStyle.bodyMedium,),
            ...
            GestureDetector(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text("Don’t have an account? ",style: textStyle.bodyMedium,),
                  Text(" Sign Up",style: textStyle.bodyMedium!.copyWith(color: AppColors.secoundaryColor,fontWeight: FontWeight.bold),)
                ],
              ),
            )
