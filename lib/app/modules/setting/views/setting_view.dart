       ...
       child: SingleChildScrollView(
         child: Column(
           children: [
             ...
             ProfileType(titel: "Move Cancel Request",onpress: (){Get.toNamed(Routes.CENCEL_REQUEST);},iconPath: Assets.iconsMoveCencel,),
             ...
             ProfileType(titel: "Temporary Switch Mover",onpress: (){
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              SizedBox(height: 04.h),
              Text("Are you sure you want to log out from your account?",textAlign: TextAlign.center,style:  Theme.of(context).textTheme!.bodyMedium,),
              SizedBox(height: 12),
              Row(
                children: [
                  Expanded(child: AppButton(titel: "No",borderColor: AppColors.secoundaryColor,bodycolor: AppColors.primaryColor,containerColor: 1,onPress: (){
