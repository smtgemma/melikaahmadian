...
class MoverMoveDetils extends StatelessWidget {
  ...
  final controller = Get.find<MoverMoveDetilsController>();
  final conversationId = ''.obs;
  @override
  Widget build(BuildContext context) {
    Future<void> crateChat() async {
                        ...
                        Expanded(
                          child: AppButton(
                            onPress: () async {
                              ...
                              print(
                                "userId $userId imagePath $ProfileImage  name $name",
                              );
                            },
      ...
      builder: (context) {
        return SizedBox(
          ...
          child: Padding(
            ...
            child: Container(
              child: ListView(
                children: List.generate(controller.cancelStatus.length, (
                  index,
                ) {
                  return Padding(
                    ...
                    child: AppButton(
                      ...
                      onPress: () {
                        ...
                        OfferReviewRepository.cancelOffer(
                          reason: controller.cancelStatus[index],
                          id: postid,
                          isMover: true,
                        );
                      },
