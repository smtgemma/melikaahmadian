                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(width: 08.w),
                                            Text(
                                              "${profileController.profileModel.value.data?.totalReview ?? "0"} Reviews",
                                              style: textStyele.bodyMedium!
                                                  .copyWith(
                                                    color:
                        ...
                        Specialties(
                          specialties:
                              profileController.selectedSpecialties.value ?? [],
                        ),
                        SizedBox(height: 24.h),
                        ...
                        SizedBox(
                          ...
                          child: Obx(
                            () => GridView.builder(
                              itemCount:
                                  profileController.vehicleImages.value.length,
                              gridDelegate:
                        ...
                        AppButton(
                          child: true,
                          iconPath: Assets.iconsProfileEdit,
                          titel: "Edit Information",
                          onPress: () {
                            Get.toNamed(Routes.PROFILE_PROFILE_EDIT);
                          },
                        ),
                        SizedBox(height: 24.h),
                      ],
